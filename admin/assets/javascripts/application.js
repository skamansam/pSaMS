      ...
      $('select#post_editor_select')
        .on('change', function() {
            ...
            var editor = $('.post-editors .post-editor[name="' + selected +
              '"]');
            $('.post-editors .post-editor')
              .addClass('hidden')
            $('.post-editors .post-editor :input')
              .attr(
                'disabled,'
                ');
                editor.removeClass('hidden'); editor.attr('name',
                  'post[body]')
              });
          ...
          .each(function() {
            var editor = $(this)
              .find(':input[name="post[body]"]');
            editor.attr('hidden-post-body-editor', 'true');
