class CoreEditor::Html
  ...
  def self.setup
    Plugin.add_action('add_editor', 'admin.posts.edit', "CoreEditor::Html", 'get_post_editor',0)
    Plugin.add_action('add_css', 'admin.posts.edit', "CoreEditor::Html", 'get_css',0)
    Plugin.add_action('add_js', 'admin.posts.edit', "CoreEditor::Html", 'get_js',0)
  end
